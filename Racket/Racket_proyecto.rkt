...
(define (pagar)
  ...
  (define cuenta-cliente (usuario-cuenta cliente))
  (define saldo (cuenta-saldo cuenta-cliente))
      ...
      (begin
        (set! lista-cliente 
              (list (usuario
                     ...
                     (cuenta (cuenta-usuario cuenta-cliente)
                             (- saldo total))))) ; Actualiza el saldo en la cuenta
        (set! carrito '())  ; Vacía el carrito
